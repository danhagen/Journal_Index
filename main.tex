...
\allowdisplaybreaks 
\begin{flalign*} 
\textit{A}&\text{Abelian groups} \hspace*{10em}&& vol. 1: p. 24\\
&\text{Adjoint operators} \hspace*{10em}&& vol. 1: pp. 43-44\\
&\text{Autonomous systems} \hspace*{10em}&& vol. 1: p. 7\\
\textit{B}&\text{Bifurcation} \hspace*{10em}&& vol. 1: pp. 11-12, 63-64\\
&\text{Body velocity} \hspace*{10em}&& vol. 1: p. 38\\
\textit{C}&\text{Centroid of area} \hspace*{10em}&& vol. 1: pp. 4-6\\
&\text{Cross product} \hspace*{10em}&& vol. 1: pp. 1-2\\
\textit{D}&\text{Dan} \hspace*{10em}&& vol. 1: pp. 1-2\\
& && vol. 2: p. 1\\
...
\textit{H}&\text{Holonomic constraint} \hspace*{10em}&& vol. 1: pp. 76-77\\
&\text{Homeomorphic} \hspace*{10em}&& vol. 1: p. 19\\
&\text{Hysteresis} \hspace*{10em}&& vol. 1: pp. 66, 70-71\\
\textit{I}&\text{Internal forces} \hspace*{10em}&& vol. 1: p. 1\\
&\text{Isomorphic} \hspace*{10em}&& vol. 1: p. 22\\
\textit{J}\textit{K}\textit{L}&\text{Lie algebra} \hspace*{10em}&& vol. 1: p. 41\\
...
\textit{M}&\text{Manifolds} \hspace*{10em}&& vol. 1: pp. 17-19\\
...
\textit{N}\textit{O}\textit{P}&\text{Phase portrait} \hspace*{10em}&& vol. 1: pp. 7-9\\
&\text{Potentials} \hspace*{10em}&& vol. 1: p. 17\\
\textit{Q}\textit{R}&\text{Reaction force} \hspace*{10em}&& vol. 1: p. 4\\
...
\textit{S}&\text{Semidirect product of two sets} \hspace*{10em}&& vol. 1: p. 24\\
...
\textit{T}&\text{Tangent spaces} \hspace*{10em}&& vol. 1: pp. 29-30\\
\textit{U}\textit{V}&\text{Varignon's theorem} \hspace*{10em}&& vol. 1: p. 1\\
&\text{Vector field} \hspace*{10em}&& vol. 1: pp. 30-31\\
\textit{W}\textit{X}\textit{Y}\textit{Z}&\text{Zero set} \hspace*{10em}&& vol. 1: p. 76\\
\end{flalign*} 
\end{document}